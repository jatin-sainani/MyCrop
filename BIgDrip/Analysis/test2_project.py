...
df = pd.read_csv("/home/scas/Documents/test_file1.csv", names=['humidity', 'temp', 'moisture', 'LDR', 'output'])
...
if userInput == 0:
    test_data = []
    test_data = getValues()
    myFile = open("/home/scas/Documents/test_data_1.csv", 'w+')
    myFile.write(test_data)
    myFile.close()
    print ("File Written")
    dt_test = pd.read_csv("/home/scas/Documents/test_data_1.csv", names=['humidity', 'temp', 'moisture', 'LDR'])
